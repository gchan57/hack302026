# hack302026
Elder fall detection project
A   project that takes data from acclerometer and sends to firebase via esp32 along with location using gps module to tell  the person wearing it is safe, active or fall .
